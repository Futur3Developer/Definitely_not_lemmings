...
BlockerLemming::BlockerLemming()
{
    setPixmap(QPixmap(":/graphics/BlockerLemming"));
}
...
void BlockerLemming::resolve_collision(QList<QGraphicsItem*> colliding_items)
{
...
void BlockerLemming::bounce_back()
{
    x_axis_speed = -x_axis_speed;
    this -> setPixmap(this->pixmap().transformed(QTransform().scale(-1, 1)));
}

void BlockerLemming::resolve_collision_with_block(QGraphicsItem *block)
{
...
void BlockerLemming::resolve_collision_with_blocker(QGraphicsItem *blocker)
{
...
void BlockerLemming::update_axis_speeds()
{
...
void BlockerLemming::start_blocking()
{
    blocking_mode = 1;
    x_axis_speed = 0;
}
